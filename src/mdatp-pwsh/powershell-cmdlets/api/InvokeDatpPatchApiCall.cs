...
namespace MdatpPwsh
{
    [Cmdlet(VerbsLifecycle.Invoke, "DatpPatchApiCall")]
    [CmdletBinding()]
    public class InvokeDatpPatchApiCall : Cmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ApiCaller apiCaller = new ApiCaller(uri, postBody, token, HttpMethod.Patch);
